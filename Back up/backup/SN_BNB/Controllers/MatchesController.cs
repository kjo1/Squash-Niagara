...
namespace SN_BNB.Controllers
{
    public class MatchesController : Controller
    {
        ...
        {
            var sNContext = _context.Matches.Include(m => m.Fixture);
        ...
        public async Task<IActionResult> Create([Bind("ID,Datetime,FixtureID")] Match match)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Datetime,FixtureID")] Match match)
        {
            if (id != match.ID)
            {
                return NotFound();
